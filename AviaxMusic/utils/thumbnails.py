...
async def gen_qthumb(vidid):
    try:
        ...
        for result in (await results.next())["result"]:
            ...
            channel = (
                result["channel"]["name"] if "channel" in result else "Unknown Channel"
            )
        ...
        create_rgb_neon_circle(
            background, (circle_position[0] + 200, circle_position[1] + 200), 200, 20
        )
        ...
        draw.text(
            (text_x_position, 180), title1[0], fill=(255, 255, 255), font=title_font
        )
        draw.text(
            (text_x_position, 230), title1[1], fill=(255, 255, 255), font=title_font
        )
        draw.text(
            (text_x_position, 320),
            f"{channel}  |  {views[:23]}",
